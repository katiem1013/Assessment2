...
def outside_1_scene():
    ...
    print("")  # blank print for formatting
    slow_type(outside_1_description)  # displays the cupboard description
    print("")  # blank print for formatting
...
def outside_3_scene():
    ...
    print("")  # blank print for formatting
    slow_type(outside_3_description)  # displays the cupboard description
    print("")  # blank print for formatting
...
def outside_12_scene():
    ...
    print("")  # blank print for formatting
    slow_type(outside_12_description)  # displays the cupboard description
    print("")  # blank print for formatting
...
def outside_13_scene():
    ...
    print("")  # blank print for formatting
    slow_type(outside_13_description)  # displays the cupboard description
    print("")  # blank print for formatting
    ...
    while True:
        ...
        if outside_13_options == "north":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_13_options == "east":  # if east is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_13_options == "south":  # if west is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_13_options == "west":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
...
def outside_14_scene():
    ...
    print("")  # blank print for formatting
    slow_type(outside_14_description)  # displays the cupboard description
    print("")  # blank print for formatting
    ...
    while True:
        ...
        if outside_14_options == "north":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_14_options == "east":  # if east is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_14_options == "south":  # if west is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_14_options == "west":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
...
def outside_15_scene():
    ...
    print("")  # blank print for formatting
    slow_type(outside_15_description)  # displays the cupboard description
    print("")  # blank print for formatting
    ...
    while True:
        ...
        if outside_15_options == "north":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_15_options == "east":  # if east is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_15_options == "south":  # if west is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_15_options == "west":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
...
def outside_16_scene():
    ...
    print("")  # blank print for formatting
    slow_type(outside_16_description)  # displays the cupboard description
    print("")  # blank print for formatting
    ...
    while True:
        ...
        if outside_16_options == "north":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_16_options == "east":  # if east is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_16_options == "south":  # if west is entered it will carry out these functions:
            print("You cannot go that way.")
    
        elif outside_16_options == "west":  # if south is entered it will carry out these functions:
            print("You cannot go that way.")
